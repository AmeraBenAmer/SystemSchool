package students;
  ...
  public class Student {
    ...
    private String state;
      ...
      public Student(int idStudent, String nameStu, int natNumber, String placeBirth, String dateBirth, String address, String dateJoin, String nameMam, String sexual, String educationStage, int phoneFamily, String studentClassRoom, String gender, int money, String status, String healthStatus, String state) {
      ...
      public String getPictureStu() {
          return pictureStu;
      }

      public void setPictureStu(String pictureStu) {
          this.pictureStu = pictureStu;
      }
      ...
      public String getNameMam() {
          return nameMam;
      }

      public void setNameMam(String nameMam) {
          this.nameMam = nameMam;
      }
      ...
      public int getPhoneFamily() {
          return phoneFamily;
      }

      public void setPhoneFamily(int phoneFamily) {
          this.phoneFamily = phoneFamily;
      }
